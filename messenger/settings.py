"""
Django settings for Messenger application.
"""
...
DEFAULT_FROM_EMAIL = os.environ.get('DEFAULT_FROM_EMAIL', 'noreply@messenger.app')
...
LOGGING = {
    ...
    'handlers': {
        'file': {
            ...
            'filename': BASE_DIR / 'logs' / 'messenger.log',
            'formatter': 'verbose',
        },
        'console': {
